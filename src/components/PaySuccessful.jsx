                                    ...
                                    <CardContent>
                                        ...
                                        <Fragment>
                                            <Grid>
                                                ...
                                                <Typography style={styles.CartSubHeading}>Thank You!</Typography>
                                                    <img style={{ marginBottom: '3%' }} src={require('../content/img/Web.png')} alt="sadad" />
                                                </Grid>
                                            </Grid>
                                            <Typography style={styles.CartSubHeading}>Your order has been placed successfully.</Typography>
